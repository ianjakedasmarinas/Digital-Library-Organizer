...
<div class="sidebar">
  ...
  <a href="#hash" class="nav-link">🔍 Hash Table</a>
  <a href="#bst" class="nav-link">🌲 BST</a>
</div>
...
<div class="main-content">
  ...
  <!-- Recursion -->
  <div id="recursion" class="card p-4">
    <h4 class="text-primary">🌀 Recursive Library Display</h4>
    <?php
    $library = [
      "Fiction" => [
  ...
  <div id="hash" class="card p-4">
    ...
    <form method="POST" action="#hash" class="mt-3">
  ...
  <div id="bst" class="card p-4">
    ...
    <form method="POST" action="#bst" class="mt-4">
      <div class="input-group">
